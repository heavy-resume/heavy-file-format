...
const THEME_COLOR_LABELS: Record<string, string> = {
  ...
  '--hvy-graph-series-1': 'Graph Series 1',
  '--hvy-graph-series-2': 'Graph Series 2',
  '--hvy-graph-series-3': 'Graph Series 3',
  '--hvy-graph-series-4': 'Graph Series 4',
  '--hvy-graph-series-5': 'Graph Series 5',
  '--hvy-graph-series-6': 'Graph Series 6',
  '--hvy-graph-series-7': 'Graph Series 7',
  '--hvy-graph-series-8': 'Graph Series 8',

const CHAT_CLI_PERSISTENT_INSTRUCTIONS = [
  ...
  '/scratchpad.txt contains ephemeral task notes. Use it for plans and verified progress, not optimistic status updates.',
  'After an edit command, inspect or search to validate it succeeded before writing success notes to scratchpad.txt.',

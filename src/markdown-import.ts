...
import { DEFAULT_READER_MAX_WIDTH, DEFAULT_SECTION_CSS, DEFAULT_SIDEBAR_MAX_WIDTH, defaultBlockSchema } from './document-factory';
...
export function convertMarkdownToHvyDocument(sourceText: string): VisualDocument {
  ...
  return {
    ...
    meta: {
      ...
      sidebar_max_width: source.meta.sidebar_max_width ?? DEFAULT_SIDEBAR_MAX_WIDTH,

const CHAT_CLI_PERSISTENT_INSTRUCTIONS = [
  'You are editing an HVY document through a virtual filesystem and virtual shell.',
  'This consists of many components (like a DOM) but in a directory structure.',

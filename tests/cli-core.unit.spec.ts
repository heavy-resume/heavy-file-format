...
<!--hvy:plugin {"id":"startup","plugin":"hvy.scripting","pluginConfig":{"version":"0.1"}}-->
doc.header.set("started", True)

<!--hvy:plugin {"id":"assign","plugin":"hvy.form","pluginConfig":{"version":"0.1","initialScript":"load","submitScript":"submit"}}-->
fields:
  - label: Chore
    type: select
scripts:
...
<!--hvy:plugin {"id":"assign","plugin":"hvy.form","pluginConfig":{"version":"0.1","submitLabel":"Assign"}}-->
fields:
  - label: Chore
    type: select
`, '.hvy');
...
<!--hvy:plugin {"id":"assign-chore","plugin":"hvy.form","pluginConfig":{"version":"0.1","submitScript":"submit"}}-->
fields:
  - label: Chore
    type: select
    required: true
...
<!--hvy:plugin {"id":"assign-chore","plugin":"hvy.form","pluginConfig":{"version":"0.1","initialScript":"load","submitScript":"submit"}}-->
fields:
  - label: Chore
    type: select
scripts:
...
<!--hvy:plugin {"id":"assign-chore","plugin":"hvy.form","pluginConfig":{"version":"0.1"}}-->
fields:
  - label: Chore
    type: select
scripts:
...
<!--hvy:plugin {"id":"broken-db","plugin":"hvy.db-table","pluginConfig":{}}-->

<!--hvy:plugin {"id":"missing-db","plugin":"hvy.db-table","pluginConfig":{"table":"missing_table"}}-->

<!--hvy:plugin {"id":"empty-script","plugin":"hvy.scripting","pluginConfig":{"version":"0.1"}}-->

<!--hvy:plugin {"id":"passive-form","plugin":"hvy.form","pluginConfig":{"version":"0.1","submitLabel":"Add chore"}}-->
fields:
  - label: Chore
    type: text
`, '.hvy');
...
test('cli commands can create a chore chart with tables and form plugins', async () => {
  ...
  await run('echo \'{"id":"add-chore-form","plugin":"hvy.form","pluginConfig":{"version":"0.1","submitLabel":"Add chore","showSubmit":true}}\' > /chore-chart/add-chore-form/plugin.json');
  ...
  await run('echo \'{"id":"assign-chore-form","plugin":"hvy.form","pluginConfig":{"version":"0.1","submitLabel":"Assign chore","showSubmit":true,"initialScript":"load"}}\' > /chore-chart/assign-chore-form/plugin.json');
  ...
  await run('echo \'{"id":"complete-chore-form","plugin":"hvy.form","pluginConfig":{"version":"0.1","submitLabel":"Complete chore","showSubmit":true}}\' > /chore-chart/complete-chore-form/plugin.json');
  await run('echo "fields:\\n  - label: Chore\\n    type: text\\n    required: true\\n  - label: Completed by\\n    type: select\\n    required: true\\n    options:\\n      - Dad\\n      - Mom\\n      - Child" > /chore-chart/complete-chore-form/plugin.txt');
  await run('hvy insert -1 plugin db-table /chore-chart weekly-leaders');
  await run('echo \'{"id":"weekly-leaders","plugin":"hvy.db-table","pluginConfig":{"source":"with-file","table":"weekly_chore_leaders","queryLimit":10}}\' > /chore-chart/weekly-leaders/plugin.json');
  ...
  expect((await run('cat /chore-chart/assign-chore-form/plugin.json')).output).toContain('"plugin": "hvy.form"');
  expect((await run('cat /chore-chart/weekly-leaders/plugin.json')).output).toContain('"table": "weekly_chore_leaders"');
  expect((await run('cat /chore-chart/weekly-leaders/plugin.json')).output).toContain('"plugin": "hvy.db-table"');
...
`, '.hvy');
  ...
  await expect(executeHvyCliCommand(document, session, 'hvy insert -1 plugin /quality bad-db db-table')).rejects.toThrow(
    'hvy plugin add: "db-table" is a CLI command alias, not a stored plugin id. Use "hvy insert INDEX plugin db-table SECTION_PATH ID" or plugin id "hvy.db-table".'
  );

  const result = await executeHvyCliCommand(
    document,
    session,
    'hvy insert -1 plugin /quality raw-scripting hvy.scripting'
  );
  ...
  expect((await executeHvyCliCommand(document, session, 'cat /body/quality/raw-scripting/plugin.json')).output)
    .toContain('"plugin": "hvy.scripting"');
});
...
`, '.hvy');
  ...
  const before = await executeHvyCliCommand(document, session, 'hvy lint');
  expect(before.output).toContain('[plugin] /body/quality/bad-db - plugin id "db-table" is a CLI command alias, not a stored plugin id. Run hvy lint --fix to change it to "hvy.db-table".');
  expect(before.output).toContain('[plugin] /body/quality/bad-form - plugin id "form" is a CLI command alias, not a stored plugin id. Run hvy lint --fix to change it to "hvy.form".');

  const fix = await executeHvyCliCommand(document, session, 'hvy lint --fix');
  expect(fix.output).toContain('Applied lint fixes:');
  expect(fix.output).toContain('- bad-db: db-table -> hvy.db-table');
  expect(fix.output).toContain('- bad-form: form -> hvy.form');
  expect(fix.mutated).toBe(true);

  const serialized = serializeDocument(document);
  expect(serialized).toContain('<!--hvy:plugin {"id":"bad-db","plugin":"hvy.db-table"');
  expect(serialized).toContain('<!--hvy:plugin {"id":"bad-form","plugin":"hvy.form"');
...
<!--hvy:plugin {"id":"bad-form","plugin":"hvy.form","pluginConfig":{"version":"0.1","submitScript":"submit"}}-->
fields:
  - label: Chore
    type: text
scripts:
...
`, '.hvy');
  ...
  await executeHvyCliCommand(document, session, 'echo \'{"id":"broken-query","plugin":"hvy.db-table","pluginConfig":{"source":"with-file","table":"chores","queryLimit":10}}\' > /quality/broken-query/plugin.json');
...
<!--hvy:plugin {"id":"missing-view","plugin":"hvy.db-table","pluginConfig":{"table":"active_chores_view"}}-->
...
<!--hvy:plugin {"id":"broken-table-name","plugin":"hvy.db-table","pluginConfig":{"table":"SELECT id AS id, title AS Chore FROM chores ORDER BY id"}}-->
`, '.hvy');
  const session = createHvyCliSession();
...
<!--hvy:plugin {"id":"spaced-table","plugin":"hvy.db-table","pluginConfig":{"table":"active chores"}}-->
`, '.hvy');
  const session = createHvyCliSession();
...
<!--hvy:plugin {"id":"reserved-table","plugin":"hvy.db-table","pluginConfig":{"table":"order"}}-->
`, '.hvy');
  const session = createHvyCliSession();
